...
enum hip_functions {
    CALL_HIP_HIP_DEVICE_SYNCHRONIZE, RET_HIP_HIP_DEVICE_SYNCHRONIZE, CALL_HIP_HIP_MALLOC, RET_HIP_HIP_MALLOC,
        ...
        RET_HIP_HIP_INIT, CALL_HIP_HIP_CTX_GET_CURRENT, RET_HIP_HIP_CTX_GET_CURRENT, CALL_HIP_HIP_MEMCPY2_D_ASYNC,
        ...
        CALL_HIP_HIP_DEVICE_GET_ATTRIBUTE, RET_HIP_HIP_DEVICE_GET_ATTRIBUTE, CALL_HIP_HIP_MODULE_LOAD_DATA,
        RET_HIP_HIP_MODULE_LOAD_DATA, CALL_HIP___DO_C_HSA_EXECUTABLE_SYMBOL_GET_INFO,
