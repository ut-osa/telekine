...
enum hip_functions {
    CALL_HIP_HIP_MALLOC, RET_HIP_HIP_MALLOC, CALL_HIP_HIP_FREE, RET_HIP_HIP_FREE, CALL_HIP_HIP_MEMCPY_DTO_H,
        ...
        CALL_HIP_HIP_STREAM_SYNCHRONIZE, RET_HIP_HIP_STREAM_SYNCHRONIZE, CALL_HIP___DO_C_HIP_GET_DEVICE_PROPERTIES,
        RET_HIP___DO_C_HIP_GET_DEVICE_PROPERTIES, CALL_HIP___DO_C_HIP_HCC_MODULE_LAUNCH_KERNEL,
        RET_HIP___DO_C_HIP_HCC_MODULE_LAUNCH_KERNEL, CALL_HIP___DO_C_HIP_MODULE_LAUNCH_KERNEL,
        RET_HIP___DO_C_HIP_MODULE_LAUNCH_KERNEL, CALL_HIP_NW_HSA_SYSTEM_MAJOR_EXTENSION_SUPPORTED,
...
struct hip_hip_memcpy2_d_async_call {
    struct command_base base;
    intptr_t __call_id;
    size_t dpitch;
    size_t spitch;
...
struct hip_hip_memcpy2_d_async_call_record {
    size_t dpitch;
    size_t spitch;
    size_t width;
    size_t height;
