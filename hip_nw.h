...
enum hip_functions {
    CALL_HIP_HIP_DEVICE_SYNCHRONIZE, RET_HIP_HIP_DEVICE_SYNCHRONIZE, CALL_HIP_HIP_MALLOC, RET_HIP_HIP_MALLOC,
        ...
        CALL_HIP_NW_HIP_MEMCPY, RET_HIP_NW_HIP_MEMCPY, CALL_HIP_HIP_MEMCPY_PEER_ASYNC, RET_HIP_HIP_MEMCPY_PEER_ASYNC,
        CALL_HIP_HIP_MEMCPY_HTO_D_ASYNC, RET_HIP_HIP_MEMCPY_HTO_D_ASYNC, CALL_HIP_HIP_MEMCPY_DTO_H_ASYNC,
        RET_HIP_HIP_MEMCPY_DTO_H_ASYNC, CALL_HIP_HIP_MEMCPY_DTO_D_ASYNC, RET_HIP_HIP_MEMCPY_DTO_D_ASYNC,
        CALL_HIP_NW_HIP_MEMCPY_SYNC, RET_HIP_NW_HIP_MEMCPY_SYNC, CALL_HIP_HIP_GET_DEVICE_COUNT,
        RET_HIP_HIP_GET_DEVICE_COUNT, CALL_HIP_NW_HIP_SET_DEVICE, RET_HIP_NW_HIP_SET_DEVICE, CALL_HIP_HIP_MEM_GET_INFO,
        RET_HIP_HIP_MEM_GET_INFO, CALL_HIP_NW_HIP_STREAM_CREATE, RET_HIP_NW_HIP_STREAM_CREATE,
        CALL_HIP_NW_HIP_GET_DEVICE, RET_HIP_NW_HIP_GET_DEVICE, CALL_HIP_HIP_INIT, RET_HIP_HIP_INIT,
        CALL_HIP_HIP_CTX_GET_CURRENT, RET_HIP_HIP_CTX_GET_CURRENT, CALL_HIP_NW_HIP_STREAM_SYNCHRONIZE,
...
struct hip_hip_memcpy_peer_async_call {
    struct command_base base;
    intptr_t __call_id;
    void *dst;
    int dstDeviceId;
...
struct hip_hip_memcpy_peer_async_ret {
    struct command_base base;
    intptr_t __call_id;
...
struct hip_hip_memcpy_peer_async_call_record {
    void *dst;
    int dstDeviceId;
    void *src;
    int srcDevice;
