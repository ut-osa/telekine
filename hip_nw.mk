...
CC=gcc
override CFLAGS+= -g -fmax-errors=10      `pkg-config --cflags glib-2.0`     -pthread -lrt -ldl -D_GNU_SOURCE     -Wall -Wno-unused-but-set-variable     -Wno-unused-variable -Wno-unused-function     -Wno-discarded-qualifiers -Wno-deprecated-declarations  -Wno-deprecated-declarations   -Wl,-z,defs -D__HIP_PLATFORM_HCC__=1 -Wno-enum-compare
