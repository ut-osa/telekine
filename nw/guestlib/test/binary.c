...
int main(int argc, char* argv[])
{
    ...
    /*  Retrieve Kernel Program Binary */
    size_t binary_size;
    char *binary;
    char kernel_name[100];

    ret = clGetProgramInfo(program, CL_PROGRAM_KERNEL_NAMES, 0, kernel_name, NULL);
    printf("binary names are %s\n", kernel_name);
    ...
    ret = clGetProgramInfo(program,
                           ...
                           &binary_size,
                           NULL);
    printf("first binary size is %ld\n", binary_size);
    binary = (char *)malloc(binary_size + 100);
